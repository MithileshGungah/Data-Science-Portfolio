...
## Repository Contents
- `FINAL_Sales_Forecasting.ipynb`  
  End-to-end workflow covering EDA, feature engineering, modeling, evaluation, SHAP analysis, and final forecasting.
...
```bash
pip install pandas numpy matplotlib plotly scikit-learn xgboost shap prophet statsmodels tensorflow
